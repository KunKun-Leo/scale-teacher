...
//        textViewX = (TextView) getActivity().findViewById(R.id.x);
//        textViewY = (TextView) getActivity().findViewById(R.id.y);
//        textViewZ = (TextView) getActivity().findViewById(R.id.z);
