...
public class ConstantBase extends AppCompatActivity {
    ...
    protected static final String basicModeTag = "SCALE TEACHER BASIC MODE";
    protected static class BasicMode {
    ...
    //测量或学习内容分类
    protected static final String studyContentTag = "SCALE TEACHER STUDY CONTENT";
    protected static class StudyContent {
        public static final int STUDY_SIZE = 0;
        public static final int STUDY_ANGLE = 1;
    }

    //（长度）测量方式分类
    protected static final String sizeMeasureMethodTag = "SCALE TEACHER SIZE MEASURE METHOD";
    protected static class SizeMeasureMethod {
    ...
    //学习目标（仅限正式教学模式）
    protected static final String studyGoalTag = "SCALE TEACHER STUDY GOAL";
}
